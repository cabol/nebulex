defmodule Nebulex.Adapter do
  ...
  """
  @callback init(opts) :: {:ok, :supervisor.child_spec() | {module(), term()} | module() | nil}
  ...
  """
  @callback get(cache, key, opts) :: value
  ...
  """
  @callback get_all(cache, [key], opts) :: map
  ...
  """
  @callback put(cache, key, value, ttl, on_write, opts) :: boolean
  ...
  """
  @callback put_all(cache, entries, ttl, on_write, opts) :: boolean
  ...
  """
  @callback take(cache, key, opts) :: value
  ...
  """
  @callback incr(cache, key, incr :: integer, ttl, opts) :: integer
  ...
  """
  @callback ttl(cache, key) :: ttl | nil
  ...
  """
  @callback expire(cache, key, ttl) :: boolean
  ...
  """
  @callback touch(cache, key) :: boolean

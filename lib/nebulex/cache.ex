defmodule Nebulex.Cache do
  ...
  #{Nebulex.Cache.Options.write_options_docs()}
  ...
  #{Nebulex.Cache.Options.replace_options_docs()}
  ...
  If the key doesn't exist, the TTL is set. Otherwise, only the counter value
  is updated, keeping the TTL set for the first time.
  ...
  #{Nebulex.Cache.Options.stream_options_docs()}

    ...
    select: [
      ...
      The possible values are:
        ...
        * `:entry` - Selects the whole entry with its fields (use it carefully).
          ...
          Therefore, Nebulex recommends seeing the adapter's documentation to
          understand the entry's structure or type along with its fields and to
          verify if the select option is supported.

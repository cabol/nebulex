defmodule Nebulex.Cache.Options do
  ...
  # Runtime common options for write operations
  ...
  def __compile_opts__, do: Keyword.keys(@compile_opts_schema.schema)
  ...
  def __start_opts__, do: Keyword.keys(@start_link_opts_schema.schema)
  ...
  def __runtime_shared_opts__, do: Keyword.keys(@runtime_shared_opts_schema.schema)
  ...
  @doc """
  This function behaves like `Keyword.pop/3`, but raises in case the value
  ...
  ## Examples
      ...
      ** (ArgumentError) invalid value for :t option: expected non-negative integer or :infinity, got: -1

      iex> Nebulex.Cache.Options.pop_and_validate_timeout!([t: nil], :t)
      ** (ArgumentError) invalid value for :t option: expected non-negative integer or :infinity, got: nil

      iex> Nebulex.Cache.Options.pop_and_validate_timeout!([k: 1], :t, :x)
      ** (ArgumentError) invalid value for :t option: expected non-negative integer or :infinity, got: :x
  ...
  ## Examples
      ...
      ** (ArgumentError) invalid value for :int option: expected integer, got: nil

      iex> Nebulex.Cache.Options.pop_and_validate_integer!([k: 1], :int, :x)
      ** (ArgumentError) invalid value for :int option: expected integer, got: :x

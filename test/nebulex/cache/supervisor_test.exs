defmodule Nebulex.Cache.SupervisorTest do
  ...
  describe "compile_config/1" do
    ...
    test "error: adapter was not compiled" do
      msg = ~r"invalid value for :adapter option: adapter TestAdapter was not compiled"
    ...
    test "error: adapter doesn't implement the required behaviour" do
      msg =
        "invalid value for :adapter option: expected the adapter module " <>
          "given to Nebulex.Cache to list Nebulex.Adapter as a behaviour"
